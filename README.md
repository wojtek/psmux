...
psmux has **first-class mouse support over SSH** when the server runs **Windows 11**. Click panes, drag-resize borders, scroll, click tabs — everything works, from any SSH client on any OS.

### Compatibility

| Client → Server | Keyboard | Mouse | Notes |
|---|:---:|:---:|---|
| Linux → Windows 11 | ✅ | ✅ | Full support |
| macOS → Windows 11 | ✅ | ✅ | Full support |
| Windows 10 → Windows 11 | ✅ | ✅ | Full support |
| Windows 11 → Windows 11 | ✅ | ✅ | Full support |
| WSL → Windows 11 | ✅ | ✅ | Full support |
| Any OS → Windows 10 | ✅ | ❌ | Windows 10 ConPTY limitation (see below) |
...
> **Recommendation:** Use Windows 11 as your psmux server for full SSH mouse support.
